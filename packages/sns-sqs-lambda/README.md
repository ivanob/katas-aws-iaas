...
### Description
This scenario implements te fanout pattern [1] where one lambda sends a message to a SNS publisher and that message gets spread to different SQSs so it can be processed in parallel. Here is a diagram of the architecture:
[Put here the pic]
...
### Bibliography
[1] https://docs.aws.amazon.com/sns/latest/dg/sns-common-scenarios.html
